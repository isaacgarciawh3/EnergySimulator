...
| R-31 | Basic tests for core logic | Done | 293 tests: accounting conservation, determinism, domain invariants, control strategy, battery physics, weather, 20 architecture rules, and 20 API integration tests |
