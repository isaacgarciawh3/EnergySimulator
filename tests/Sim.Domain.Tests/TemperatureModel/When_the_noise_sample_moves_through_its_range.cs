...
public class When_the_noise_sample_moves_through_its_range
{
    ...
    private readonly double _atTheCentre = Sim.Simulation.Domain.Weather.TemperatureModel.OffsetByNoiseC(0.5, P);
    private readonly double _atTheBottom = Sim.Simulation.Domain.Weather.TemperatureModel.OffsetByNoiseC(0.0, P);
    private readonly double _atTheTop = Sim.Simulation.Domain.Weather.TemperatureModel.OffsetByNoiseC(1.0, P);
