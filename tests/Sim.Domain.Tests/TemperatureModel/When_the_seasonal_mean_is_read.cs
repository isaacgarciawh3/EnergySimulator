...
public class When_the_seasonal_mean_is_read
{
    ...
    private readonly double _onTheColdestDay = Sim.Simulation.Domain.Weather.TemperatureModel.SeasonalMeanC(P.ColdestDayOfYear, P);
    private readonly double _atMidsummer = Sim.Simulation.Domain.Weather.TemperatureModel.SeasonalMeanC(196, P);
    private readonly double _atMidwinter = Sim.Simulation.Domain.Weather.TemperatureModel.SeasonalMeanC(15, P);
