...
public class When_cloud_attenuates_the_sky
{
    ...
    private readonly double _underAClearSky = Sim.Simulation.Domain.Weather.SolarGeometry.AttenuateByCloud(1.0, 0.0, P);
    private readonly double _underTotalCloud = Sim.Simulation.Domain.Weather.SolarGeometry.AttenuateByCloud(1.0, 1.0, P);
